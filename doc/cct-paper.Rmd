...
**Results**  
The SWOT analysis indicated that the CCT programme had a robust design with a huge potential for operational effectiveness if diligently implemented. However, the programme was faced with several implementation challenges. For instance, though 65% of beneficiaries perceived CCT pay-out events to be orderly and well-organized, in some of the pilot states the events were marred with inconsistencies resulting in large crowds and increased waiting time for beneficiaries. Similarly, only 40% of beneficiaries received the complete N5,000 (USD30) cash incentive while  28% received only N1,000 (USD6) while others received either N2000 (USD12), N3000 (USD18) or N4000 (USD24).  
